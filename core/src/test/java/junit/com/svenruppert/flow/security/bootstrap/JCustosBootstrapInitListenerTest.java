...
import com.svenruppert.flow.security.bootstrap.JCustosBootstrapInitListener;
...
@DisplayName("JCustosBootstrapInitListener — serviceInit() wiring")
class JCustosBootstrapInitListenerTest {
  ...
  void registersOneUIInitListener() {
    ...
    new JCustosBootstrapInitListener().serviceInit(event);
  ...
  void doneFlagFlips() throws Exception {
    ...
    new JCustosBootstrapInitListener()
  ...
  void secondCallSkipsPipeline() throws Exception {
    JCustosBootstrapInitListener listener = new JCustosBootstrapInitListener();
  ...
  private static boolean doneValue() throws Exception {
    Field f = JCustosBootstrapInitListener.class.getDeclaredField("DONE");
