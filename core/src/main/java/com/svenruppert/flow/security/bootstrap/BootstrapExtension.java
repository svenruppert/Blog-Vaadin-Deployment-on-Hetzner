 ...
 * layers ({@code jcustos-vaadin-persistence},
 * {@code jcustos-vaadin-hardening}, future {@code -mfa} /
 * {@code -multi-tenant} etc.) each ship one implementation registered
 * via {@code META-INF/services/} + {@link #SERVICE_NAME}.
 *
 * <p>{@link BootstrapBuilder#apply(eu.jsentinel.jcustos.dx.vaadin.bootstrap.VaadinJCustosBootstrap)}
