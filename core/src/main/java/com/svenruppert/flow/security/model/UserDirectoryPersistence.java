 ...
 *       default, persists the user map as the root of the shared
 *       application store ({@code app()} half of the single storage
 *       pair). No separate manager, directory or shutdown hook.</li>
