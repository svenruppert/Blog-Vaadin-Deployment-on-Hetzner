...
class BootstrapBuilderTest {
  ...
  void applyReturnsSameBuilder() {
    ...
    VaadinJCustosBootstrap given = chain.proxy();

    VaadinJCustosBootstrap result = BootstrapBuilder.apply(given);
   ...
   * {@code credentials(Consumer)} call on a synthetic {@link VaadinJCustosBootstrap}.
  ...
  private static final class RecordingBootstrapChain {
    ...
    VaadinJCustosBootstrap proxy() {
      return (VaadinJCustosBootstrap) Proxy.newProxyInstance(
          VaadinJCustosBootstrap.class.getClassLoader(),
          new Class<?>[]{VaadinJCustosBootstrap.class},
    ...
    private Object dispatch(Object proxy, Method method, Object[] args) {
      ...
      switch (name) {
        ...
        case "credentials":
          ...
          return proxy;
        default:
          // every other CommonJCustosBootstrap method returns the builder
          if (method.getReturnType().isAssignableFrom(VaadinJCustosBootstrap.class)) {
            return proxy;
          }
          return null;
      }
  ...
  private static final class OrderRecordingCredentialBootstrap implements CredentialBootstrap {
    final List<eu.jsentinel.jcustos.credential.password.PasswordHashingService> hashingProfileOrder = new ArrayList<>();

    @Override public CredentialBootstrap passwordHasher(eu.jsentinel.jcustos.authentication.PasswordHasher h) {
      return this;
    }
    @Override public CredentialBootstrap hashing(eu.jsentinel.jcustos.credential.password.PasswordHashingService s) {
    ...
    @Override public CredentialBootstrap pepper(eu.jsentinel.jcustos.credential.password.pepper.PepperService p) {
      return this;
    }
    @Override public CredentialBootstrap credentialStore(eu.jsentinel.jcustos.credential.store.CredentialStore s) {
      return this;
    }
