...
public class SecurityFeaturesView extends Composite<VerticalLayout>
  ...
  public static final String JCUSTOS_URL = "https://8g8.eu/sentinel4j";
  ...
  public SecurityFeaturesView() {
        ...
        new FeatureCard(VaadinIcon.LOCK,
            ...
            tr(K_C_BOOT_B,
                "One-time token printed at JVM start + persisted to "
                    + "./data/jcustos/bootstrap.token. The setup form "
    ...
    content.add(buildSection(
        ...
        new FeatureCard(VaadinIcon.WARNING,
            ...
            tr(K_C_DRIFT_B,
                "Role changes bump the subject''s JCustosVersion. "
        ...
        new FeatureCard(VaadinIcon.EXCHANGE,
            ...
            tr(K_C_PROP_B,
                "The jCustos 00.74 TokenCredentialStore + "
  ...
  private Div buildHero() {
    ...
    Anchor eyebrowLink = new Anchor(JCUSTOS_URL,
        ...
        new Span(tr(K_EYEBROW, "Powered by jCustos")),
